...
namespace offsets
{
    ...
    const DWORD dwEntityList = 0x4dbf75c;
    const DWORD dwForceAttack = 0x31efcd4;
    const DWORD dwForceAttack2 = 0x31efce0;
    const DWORD dwForceBackward = 0x31efc8c;
    const DWORD dwForceForward = 0x31efc98;
    const DWORD dwForceJump = 0x5269570;
    const DWORD dwForceLeft = 0x31efcb0;
    const DWORD dwForceRight = 0x31efca4;
    const DWORD dwGameDir = 0x627700;
    const DWORD dwGameRulesProxy = 0x52dc84c;
    const DWORD dwGetAllClasses = 0xdcda84;
    const DWORD dwGlobalVars = 0x588cf0;
    const DWORD dwGlowObjectManager = 0x5307c48;
    const DWORD dwInput = 0x5210d20;
    ...
    const DWORD dwPlayerResource = 0x31ee000;
    const DWORD dwRadarBase = 0x51f44d4;
    const DWORD dwSensitivity = 0xdaae34;
    const DWORD dwSensitivityPtr = 0xdaae08;
    const DWORD dwSetClanTag = 0x8a130;
    const DWORD dwViewMatrix = 0x4db1074;
    const DWORD dwWeaponTable = 0x52117e4;
    ...
    const DWORD find_hud_element = 0x50692ea0;
    ...
    const DWORD m_pitchClassPtr = 0x51f4770;
