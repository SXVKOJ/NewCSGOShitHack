...
namespace offsets
{
    ...
    const DWORD dwEntityList = 0x4dbf78c;
    const DWORD dwForceAttack = 0x31efd04;
    const DWORD dwForceAttack2 = 0x31efd10;
    const DWORD dwForceBackward = 0x31efcbc;
    const DWORD dwForceForward = 0x31efcc8;
    const DWORD dwForceJump = 0x52695a0;
    const DWORD dwForceLeft = 0x31efce0;
    const DWORD dwForceRight = 0x31efcd4;
    const DWORD dwGameDir = 0x627700;
    const DWORD dwGameRulesProxy = 0x52dc87c;
    const DWORD dwGetAllClasses = 0xdcda84;
    const DWORD dwGlobalVars = 0x588cf0;
    const DWORD dwGlowObjectManager = 0x5307c78;
    const DWORD dwInput = 0x5210d50;
    const DWORD dwInterfaceLinkList = 0x956aa4;
    const DWORD dwLocalPlayer = 0xda544c;
    const DWORD dwMouseEnable = 0xdaaf98;
    const DWORD dwMouseEnablePtr = 0xdaaf68;
    const DWORD dwPlayerResource = 0x31ee030;
    const DWORD dwRadarBase = 0x51f4504;
    const DWORD dwSensitivity = 0xdaae34;
    const DWORD dwSensitivityPtr = 0xdaae08;
    const DWORD dwSetClanTag = 0x8a130;
    const DWORD dwViewMatrix = 0x4db10a4;
    const DWORD dwWeaponTable = 0x5211814;
    const DWORD dwWeaponTableIndex = 0x326c;
    const DWORD dwYawPtr = 0xdaabf8;
    const DWORD dwZoomSensitivityRatioPtr = 0xdafe98;
    const DWORD dwbSendPackets = 0xd7bd2;
    const DWORD dwppDirect3DDevice9 = 0xa7050;
    const DWORD find_hud_element = 0x2b9b2ea0;
    ...
    const DWORD m_pitchClassPtr = 0x51f47a0;
    const DWORD m_yawClassPtr = 0xdaabf8;
